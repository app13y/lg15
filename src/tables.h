#if !defined GOSTHOPPER_TABLES_HEADER_INCLUDED_
#define GOSTHOPPER_TABLES_HEADER_INCLUDED_

/** @internal Exponents table (generator = 0x02 in GF(256) modulo g(x) = 111000011). */
...
/** @internal Discrete logarithms table (generator = 0x02 in GF(256) modulo g(x) = 111000011). */
...
/** @internal Pi substitution box defined by GOST 34.12 '2015. */
...
/** @internal Inversed Pi substitution box. */
...
/** @internal L transformation matrix over GF(256). */
...
/** @internal Inversed L transformation matrix over GF(256). */
